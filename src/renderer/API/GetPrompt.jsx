function getPromptFromCodeBlock(code_block) {
    ...
    out_str += `\nPlease only provide the code for the function without test examples or any other code. Give the respinse just as text without trying to wrap it in a code environment.`;
    return out_str;
}
